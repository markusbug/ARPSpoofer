...
import threading
import signal
testii = raw_input("Please put in the Interface you want to use:\n")
mister = raw_input("Please put in the Target-IP:\n")
lister = raw_input("Please put in the Network-Gateway:\n")
INTERFACE       =   testii
TARGET_IP       =   mister
GATEWAY_IP      =   lister
PACKET_COUNT    =   1000
